...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/schnetpack-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7558&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/schnetpack-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `schnetpack` can be installed with:

```
conda install schnetpack
```

It is possible to list all of the versions of `schnetpack` available on your platform with:
